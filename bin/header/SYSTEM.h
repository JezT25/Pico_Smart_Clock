...
class SYSTEM_class {
    ...
    public:
        SYSTEM_class(SystemComponents& class_lib) : _IData(class_lib._IData), _ISystem(class_lib._ISystem), _HARDWARE(class_lib._HARDWARE), _LED(class_lib._LED), _TIME(class_lib._TIME), _HWIO(class_lib._HWIO) {}
